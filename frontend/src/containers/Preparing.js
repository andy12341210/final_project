...
const Preparing = ()=>{
    ...
    const {Mode,setMode,isPrepared,setIsPrepared,isPrepareds,setIsPrepareds,playerNames,playerCharacters} = useMonopoly()
    ...
    return (
        <div>
            ...
            {id_list.map((id)=>{
                return <PlayerWrapper id={"p"+id} className={isPrepareds[id]?"IsPrepared":"NotPrepared"} alt="">
